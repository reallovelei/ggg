...
var githubAPI = []route{
	...
	//{web.MethodPut, "/authorizations/clients/:client_id"},
	//{web.MethodPatch, "/authorizations/:id"},
	...
	//{web.MethodPatch, "/notifications/threads/:id"},
	...
	//{web.MethodGet, "/gists/public"},
	//{web.MethodGet, "/gists/starred"},
	{http.MethodGet, "/gists/:id"},
	{http.MethodPost, "/gists"},
	//{web.MethodPatch, "/gists/:id"},
	...
	//{web.MethodGet, "/repos/:owner/:repo/git/refs/*ref"},
	{http.MethodGet, "/repos/:owner/:repo/git/refs"},
	{http.MethodPost, "/repos/:owner/:repo/git/refs"},
	//{web.MethodPatch, "/repos/:owner/:repo/git/refs/*ref"},
	//{web.MethodDelete, "/repos/:owner/:repo/git/refs/*ref"},
	...
	//{web.MethodPatch, "/repos/:owner/:repo/issues/:number"},
	...
	//{web.MethodGet, "/repos/:owner/:repo/issues/comments"},
	//{web.MethodGet, "/repos/:owner/:repo/issues/comments/:id"},
	{http.MethodPost, "/repos/:owner/:repo/issues/:number/comments"},
	//{web.MethodPatch, "/repos/:owner/:repo/issues/comments/:id"},
	//{web.MethodDelete, "/repos/:owner/:repo/issues/comments/:id"},
	{http.MethodGet, "/repos/:owner/:repo/issues/:number/events"},
	//{web.MethodGet, "/repos/:owner/:repo/issues/events"},
	//{web.MethodGet, "/repos/:owner/:repo/issues/events/:id"},
	{http.MethodGet, "/repos/:owner/:repo/labels"},
	{http.MethodGet, "/repos/:owner/:repo/labels/:name"},
	{http.MethodPost, "/repos/:owner/:repo/labels"},
	//{web.MethodPatch, "/repos/:owner/:repo/labels/:name"},
	...
	//{web.MethodPatch, "/repos/:owner/:repo/milestones/:number"},
	...
	//{web.MethodPatch, "/repos/:owner/:repo/pulls/:number"},
	...
	//{web.MethodGet, "/repos/:owner/:repo/pulls/comments"},
	//{web.MethodGet, "/repos/:owner/:repo/pulls/comments/:number"},
	{http.MethodPut, "/repos/:owner/:repo/pulls/:number/comments"},
	//{web.MethodPatch, "/repos/:owner/:repo/pulls/comments/:number"},
	//{web.MethodDelete, "/repos/:owner/:repo/pulls/comments/:number"},
	...
	//{web.MethodPatch, "/repos/:owner/:repo"},
	...
	//{web.MethodPatch, "/repos/:owner/:repo/comments/:id"},
	...
	//{web.MethodGet, "/repos/:owner/:repo/contents/*path"},
	//{web.MethodPut, "/repos/:owner/:repo/contents/*path"},
	//{web.MethodDelete, "/repos/:owner/:repo/contents/*path"},
	//{web.MethodGet, "/repos/:owner/:repo/:archive_format/:ref"},
	{http.MethodGet, "/repos/:owner/:repo/keys"},
	{http.MethodGet, "/repos/:owner/:repo/keys/:id"},
	{http.MethodPost, "/repos/:owner/:repo/keys"},
	//{web.MethodPatch, "/repos/:owner/:repo/keys/:id"},
	...
	//{web.MethodPatch, "/repos/:owner/:repo/hooks/:id"},
	...
	//{web.MethodPatch, "/repos/:owner/:repo/releases/:id"},
