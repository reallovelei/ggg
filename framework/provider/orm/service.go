...
type GGGOrm struct {
	...
	dbs       map[string]*gorm.DB // key:dsn value:gorm.DB(连接池)
	lock      *sync.RWMutex
}

// NewGGGOrm 代表实例化Gorm
func NewGGGOrm(params ...interface{}) (interface{}, error) {
...
func (app *GGGOrm) GetDB(option ...contract.DBOption) (*gorm.DB, error) {
