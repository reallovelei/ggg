...
// GGGRedis 代表 ggg 框架的redis实现
type GGGRedis struct {
...
// NewGGGRedis 代表实例化Client
func NewGGGRedis(params ...interface{}) (interface{}, error) {
...
func (app *GGGRedis) GetClient(option ...contract.RedisOption) (*redis.Client, error) {
    // 读取默认配置
